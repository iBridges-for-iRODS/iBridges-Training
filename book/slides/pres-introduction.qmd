...
digraph ibridges_prc {
    ...
    GuiPermissions -> IrodsPath[label="calls", ltail="cluster_gui_features", lhead="cluster_api_features"]
    CliNavigation -> IrodsPath[label="calls", ltail="cluster_cli_features", lhead="cluster_api_features"]

    // cluster_gui_features -> cluster_api_features;
    // Relationships inside API features
    DataOps   -> Session     [label="uses"];
    IrodsPath -> Session     [label="uses"];
    Permissions -> Session   [label="uses"];

    Session   -> PrcCollections[label="calls", ltail="cluster_api_features", lhead="cluster_prc"];
}
```
  <!-- </div> -->
<!-- </div> -->
