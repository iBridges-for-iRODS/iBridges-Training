...
This section helps learners understand how both interfaces relate to each other.  
It reinforces the idea that the GUI and CLI are two views on the same iRODS concepts.
