...
digraph ibridges_prc {
    ...
    graph [fontsize=11, fontname="Arial", rank = TB, style=rounded, color="#15a589"];
    node  [
        shape=box,
        style=filled,
        color="#15a589",
    ...
    subgraph cluster_gui_features {
        label="iBridges Graphical User Interface";

        GuiDataOps[label="Data operations"];
        GuiIrodspath[label="IrodsPath"];
        GuiMetadata[label="Metadata operations"];
        GuiPermissions[label="Permission operations"]
    }

    subgraph cluster_cli_features {
        label="iBridges Command Line Interface";

        CliDataOps[label="Data operations"];
        CliNavigation[label="Navigation"];
        CliMetadata[label="Metadata operations"];
        CliPermissions[label="Permission operations"]
    }

    subgraph cluster_prc {
        label="Python iRODS client (PRC)";
        PrcSession[label="iRODSSession"];
        PrcDataObjects[label="data_objects"];
        PrcCollections[label="collections"];
        PrcPut[label="put"];
        PrcGet[label="get"];
        PrcACLs[label="Permissions"];
        PrcRescs[label="Resources"]
    }


    GuiDataOps -> IrodsPath[label="calls", ltail="cluster_gui_features", lhead="cluster_api_features"]
    CliPermissions -> IrodsPath[label="calls", ltail="cluster_cli_features", lhead="cluster_api_features"]
    ...
    Session   -> PrcPut[label="calls", ltail="cluster_api_features", lhead="cluster_prc"];
}
```
